...
export function TrustTimelinePanel({ records }: { records: VerificationRecord[] }) {
  ...
  return (
    <div className="panel rounded-lg p-6">
      <div className="mb-4">
        <p className="text-lg font-semibold">Trust timeline</p>
        <p className="text-sm text-slate-400">Track how the trust fingerprint evolves as related content enters the system.</p>
      </div>
      <div className="h-72">
